  ...
  module Geocoders
    ...
    class GoogleGeocoder < Geocoder
      ...
      def self.do_reverse_geocode(latlng)
        ...
        res = self.call_geocoder_service("http://maps.googleapis.com/maps/api/geocode/xml?latlng=#{Geokit::Inflector::url_escape(latlng.ll)}&sensor=false")
    ...
    class MultiGeocoder < Geocoder
      ...
      def self.do_geocode(address, options = {})
        ...
        logger.error("Something has gone very wrong and we have failed Geocoding completely.")
      ...
      def self.do_reverse_geocode(latlng)
        ...
        logger.error("Something has gone very wrong and we have failed Reverse Geocoding completely.")
        # If we get here, we failed completely.
        GeoLoc.new
      end
    end
